...
2. One by one, execute the following commands:
    ...
    ```
1. In the VS Code file explorer navigate to any typescript file e.g. `front/src/App.tsx`
2. The message box "This workspace contains a typescript version..." should appear. Click the "Allow" button to configure typescript type checking.
  ` ../../../assets/vs-code-yarn-typescript-setup.png`
